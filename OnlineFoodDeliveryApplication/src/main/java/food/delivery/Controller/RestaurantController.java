...
import food.delivery.Service.IRestaurantService;
...
public class RestaurantController {
   ...
   private IRestaurantService restaurantService;
	...
	@GetMapping("/{location}")
	public ResponseEntity<List<Restaurant>> viewAllRestaurant(@PathVariable String location)throws Exception {
		List<Restaurant> restaurant2=restaurantService.viewBearRestaurants(location);
